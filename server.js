...
app.get('/pBusquedaProducto/:par1/:par2',persons.getpBusquedaProducto) 
app.get('/getpCrearNevaCategoria/:par1/:par2',persons.getpCrearNevaCategoria) 
app.get('/getpCrearNevoProducto/:par1/:par2/:par3',persons.getpCrearNevoProducto) 
...
app.get('/getpBuscarProductoCategoria/:par1/:par2',persons.getpBuscarProductoCategoria)
